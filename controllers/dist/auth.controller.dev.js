...
var sendEmailActivate = function sendEmailActivate(email, user) {
  ...
  var message = "\n  <!DOCTYPE html>\n  <html lang=\"es\">\n    <head>\n      <meta charset=\"UTF-8\" />\n      <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\" />\n      <title>Confirma tu cuenta</title>\n      <style>\n        body {\n          font-family: Arial, sans-serif;\n          background-color: #f4f4f4;\n          color: #333;\n          margin: 0;\n          padding: 0;\n        }\n        .container {\n          max-width: 600px;\n          margin: 0 auto;\n          background-color: #fff;\n          padding: 20px;\n          border-radius: 8px;\n          box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);\n        }\n        h1 {\n          color: #ff6f00;\n          text-align: center;\n        }\n        p {\n          font-size: 16px;\n          line-height: 1.5;\n        }\n        .button {\n          display: inline-block;\n          margin-top: 20px;\n          padding: 15px 30px;\n          background-color: #ff6f00;\n          color: white;\n          text-decoration: none;\n          border-radius: 5px;\n          font-size: 16px;\n          text-align: center;\n        }\n        .button:hover {\n          background-color: #e65c00;\n        }\n        .footer {\n          margin-top: 30px;\n          text-align: center;\n          font-size: 12px;\n          color: #777;\n        }\n      </style>\n    </head>\n    <body>\n      <div class=\"container\">\n        <h1>Confirma tu cuenta en Distri7030</h1>\n        <p>Hola,</p>\n        <p>Tu cuenta ha sido creada exitosamente. Para activarla, confirma tu correo electr\xF3nico haciendo clic en el bot\xF3n de abajo. Adem\xE1s, tendr\xE1s la opci\xF3n de establecer una contrase\xF1a.</p>\n        \n        <p>Detalles de tu cuenta:</p>\n        <ul>\n          <li><strong>Correo electr\xF3nico:</strong> ".concat(user.email, "</li>\n        </ul>\n\n        <a href=\"").concat(urlConfirm, "\" class=\"button\">CONFIRMAR EMAIL</a>\n\n        <p><small>Este enlace es v\xE1lido por 3 d\xEDas.</small></p>\n\n        <div class=\"footer\">\n          <p>\xA9 2024 Distri7030. Todos los derechos reservados.</p>\n        </div>\n      </div>\n    </body>\n  </html>\n  ");
