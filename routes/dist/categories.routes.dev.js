...
router.post("/create-category", _categoriesController.createCategory);
...
router.get("/get-two-categories/:categoryID", _categoriesController.getTwoCategoriesWithImages);
